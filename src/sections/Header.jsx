...
const Header = () => {
    ...
    // For managing the sticky header nav 
    useEffect(() => {
      const handleScroll = () => {
    ...
    const Navlink = ({ title }) => (
        ...
        <LinkScroll onClick={() => setIsOpen(false)} to={title} offset={-100} spy smooth activeClass='nav-active' className='base-bold text-p4 uppercase transition-colors duration-1000
        ...
        <div className='container flex h-14 items-center max-lg:px-5'>
                    ...
                    <nav className='max-lg:relative max-lg:z-2 max-lg:my-auto'>
                        ...
                        <ul className='flex max-lg:block max-lg:px-12'>
                            ...
                            <li className='nav-logo'>
                                <LinkScroll to='hero' offset={-250} spy smooth className={clsx('max-lg:hidden transform duration-500 cursor-pointer')} >
            ...
            <button className='lg:hidden z-2 size-10 border-2 
              border-s4/25 rounded-full flex justify-center items-center' 
                ...
                <img src={`/images/${isOpen ? 'close' : 'magic'}.svg`} alt="magic button" 
